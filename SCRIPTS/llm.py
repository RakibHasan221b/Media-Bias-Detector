...
class BiasEngine:
    """Main class - Generates bias analysis using GPT."""
...
Maintain a strictly neutral, objective, and academic tone throughout. Be evidence-based and fair to both sides."""
        ...
        response = self.client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a precise, evidence-based media bias analyst. Always remain neutral and analyze both sides fairly. Never hallucinate.",
                },
...
Finally, give an Overall Score out of 10 and a short final comment."""
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a highly critical, fair, and detailed academic evaluator.",
                },
